...
## iaddl and ileave instructions are more robust for this hcl code.
## to add these instructions, modification is required in every stage.
## The stall stage was also modified. The modification were made 
## keeping the ncopy.ys in mind. so that it would not have any conflict
## regarding stalling or data forwarding.
